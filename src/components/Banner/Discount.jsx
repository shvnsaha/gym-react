            ...
            <div className="bg-[#f9f9f9] py-14 md:py-24 flex justify-center items-center">
                ...
                <div className="flex flex-col justify-center text-center space-y-8 lg:px-44">
                    <motion.h1 
                     ...
                     initial="hidden"
                     whileInView={"visible"}
                     viewport={{ once: true }} className="text-3xl lg:text-5xl font-bold uppercase">Get 20% Discount On Your First Order, Are You Ready To Buy</motion.h1>
                    <motion.p
                    ...
                    <motion.div  
                     ...
                     className="flex justify-center gap-6">
                        ...
                        <button className="border-2 border-primary text-primary font-bold px-6 py-3 rounded-md">Stay In Touch</button>
                    </motion.div>
                </div>
            </div>
